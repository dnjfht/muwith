interface PlayTimeProgressBarProps {
  playTimePercent: number;
  player: YT.Player | null;
  wrapStyle: string;
}

export function PlayTimeProgressBar({ playTimePercent, player, wrapStyle }: PlayTimeProgressBarProps) {
  ...
  return (
    <div onClick={handleClick} className={`${wrapStyle} h-[6px] border-[1px] border-solid border-white rounded-2xl`}>
